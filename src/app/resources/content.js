...
const home = {
    ...
    description: `Ale𝕏, Software Engineer | Personal Portfolio website showcasing my work. as a ${person.role}`,
    headline: <>Software Engineer and Builder</>,
    subline: <>I'm Ale𝕏 , a Software Engineer & Founder at <InlineCode>BearifiedCo</InlineCode> where we craft intuitive<br/> user experiments & experiences. After hours, I build my own projects.</>
}
